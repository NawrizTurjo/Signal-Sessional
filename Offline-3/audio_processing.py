...
# print(sample_rate, max_freq, num_freqs)
...
filtered_ft_data[0] = np.where((frequencies < 1000),0, filtered_ft_data[0])
filtered_ft_data[1] = np.where((frequencies < 1000),0, filtered_ft_data[1])
